...
function loadRoutes(routesConfig) {
    ...
    //     console.error('the usage of signature loadRoutes({router, store, i18n.js}, routesConfig) is out of date, please use the new signature: loadRoutes(routesConfig).')
    //     console.error('方法签名 loadRoutes({router, store, i18n.js}, routesConfig) 的用法已过时, 请使用新的方法签名 loadRoutes(routesConfig)。')
    //   }
    // }
    /*************** 兼容 version < v0.6.1 *****************/
    ...
    // 一开始登录 routesConfig 是 undefined；所以从本地获取 store.getters['account/routesConfig']
    if (routesConfig) {
    ...
    // 如果开启了异步路由，则加载异步路由配置 默认没有开启异步路由
